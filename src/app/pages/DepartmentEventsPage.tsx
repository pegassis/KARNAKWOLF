  ...
  'electrical': {
    ...
    events: [
      ...
      },
      {
        ...
        description: 'The campus is under threat, and the countdown has begun at Karnak 26! We need the brightest minds to step up, solve the puzzles, and save the day. Do you have the nerves to handle the pressure?\n\nRULES AND REGULATIONS:\n The Digital Trail: Scan QR Codes at each location to receive your next "Intelligence Report."\n*The Sequence: Collect a Single Digit Number at every station. You need them all, in order, to form the Deactivation Code.\n*The Fail-Safe: Finding the bomb isnt the end. Once opened, you must solve a Final Encoded Question to officially disarm it.\n *No Brute Force: Guessing the code or forcing the lock results in immediate detonation (disqualification).',
        date: 'February 27, 2026',
        time: '11:00 AM',
        fee: '50',
        venue: 'M22',
        prizepool:'2000',
        badge: 3,
        image: '/depfolds/eee/bomborg.jpeg',
